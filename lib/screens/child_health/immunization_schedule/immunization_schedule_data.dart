...
class _ImmunizationDataState extends State<ImmunizationData> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<ImmunizationScheduleBloc, ImmunizationScheduleState>(builder: (BuildContext context, state) {
