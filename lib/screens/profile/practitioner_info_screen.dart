        ...
        content: Column(
          children: <Widget>[
            DropdownButtonFormField(
              ...
              iconSize: 30.0,
              style: TextStyle(color: Colors.black),
              items: ['Not Applicable','Hospital', 'Clinic', 'Pharmacy','Health Insurer','Rehab','Physio', 'Lab','Diagnostics','Imaging Centres','Mental Health Facility','Hospice','Specialties','Others'].map(
                    (val) {
            ...
            DropdownButtonFormField(
              ...
              iconSize: 30.0,
              style: TextStyle(color: Colors.black),
              items: ['Not Applicable', 'Doctor', 'Dentist','Nurse','Pharmacist','Clinician','Physician Assistant', 'Paramedic','Psychologist','Counsellor','Physiotherapist','Occupational therapist','Speech Therapist','Nutritionists & Dieticians','Physical Trainer',' Chiropractor','Lab Personnel','Health Insurance Agent','Other'].map(
                    (val) {
                  return DropdownMenuItem<String>(
                    value: val,
                    child: Text(val),
            ...
            DropdownButtonFormField(
              ...
              iconSize: 30.0,
              style: TextStyle(color: Colors.black),
              items: ['Not Applicable', 'General Practice', 'Family Physician','Internist','Pediatrics','Children Surgery','Obstetrics & Gynecology','Ear,Nose & Throat Specialty','Eye Specialty','General Surgery','Bone & Muscle','Skin Dermatology','Psychiatry','Psychology','Pathology','Cancer Specialist','Chest & Breathing','Heart & Vessels - Cardiologist','Chest Heart & Vascular Surgery','Diabetes & Hormones Specialty','Head Brain & Nerves Specialty','Head Brain & Nerves Surgery','Digestive Gut Specialty','Urology', 'Plastic & Reconstruction Surgery','Anesthesia', 'Allergy & Immunology','Joints & Rheumatology','Public Health','Research','Other'].map(
                    (val) {
                  return DropdownMenuItem<String>(
                    value: val,
                    child: Text(val),
        ...
        content: Column(
          children: <Widget>[
            ...
            GestureDetector(
              ...
              child: BlocBuilder<PractitionerProfileBloc,PractitionerProfileState>(
    ...
    return BlocListener<PractitionerProfileBloc,PractitionerProfileState>(
      listener: (context,state){
        if(state is PractitionerProfileLoaded){
          if (state.practitionerProfile.user_id != null) {
            setState(() {
              percentage = 1.0;
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(height: 9,),
                    Text("Sign Up Progress $percentageNumber%",style: TextStyle(fontSize: 12),),
