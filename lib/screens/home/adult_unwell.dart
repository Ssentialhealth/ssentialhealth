              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    AdultUnwellMenuItems(
                      text: "Runny Nose",
                    ),
                    AdultUnwellMenuItems(
                      text: "Nasal Irritation/Nose Irritation",
                    ),
                    AdultUnwellMenuItems(
                      text: "Sore Throat/Swallowing pain",
                    ),
                    AdultUnwellMenuItems(
                      text: "Cough",
                    ),
                    ...
                    AdultUnwellMenuItems(
                      text: "Abdominal pain/Stomachache",
                    ),
                    AdultUnwellMenuItems(
                    ...
                    AdultUnwellMenuItems(
                      text: "Abdominal swelling/distention",
                    ),
                    AdultUnwellMenuItems(
                      text: "Constipation",
                    ),
                    ...
                    AdultUnwellMenuItems(
                      text: "Genital discharge or itchiness",
                    ),
                    AdultUnwellMenuItems(
                      text: "Genital odour",
                    ),
                    ...
                    AdultUnwellMenuItems(
                      text: "Skin Rash/Skin Issues",
                    ),
                    AdultUnwellMenuItems(
                      text: "Backache",
                    ),
                    AdultUnwellMenuItems(
                      text: "Pain in limbs/joints or Limb swelling",
                    ),
                    AdultUnwellMenuItems(
                      text: "Eye itchiness, redness, tears",
                    ),
                    AdultUnwellMenuItems(
                      text: "Eye discharge",
                    ),
                    ...
                    AdultUnwellMenuItems(
                      text: "Sadness or Hopelessness ",
                    ),
                    AdultUnwellMenuItems(
                      text: "Injury or Physical Trauma ",
                    ),
                    AdultUnwellMenuItems(
                      text: "Burn or Electrocution ",
                    ),
                    AdultUnwellMenuItems(
                      text: "Other ",
                    ),
