...
import 'package:pocket_health/bloc/filter_facility_reviews/filter_facility_reviews_cubit.dart';
...
class FacilityProfileScreen extends StatefulWidget {
  final FacilityProfileModel facilityProfileModel;
  final isVerified;

  const FacilityProfileScreen({Key key, this.facilityProfileModel, this.isVerified}) : super(key: key);
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        //deets
                        Hero(
                          tag: "facility-profile-${widget.facilityProfileModel.id}",
                          child: Material(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    CircleAvatar(
                                      radius: 40.w,
                                      backgroundImage: widget.facilityProfileModel.profileImgUrl != ""
                                          ? NetworkImage(widget.facilityProfileModel.profileImgUrl)
                                      ...
                                      children: [
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            //name
                                            Text(
                                              widget.facilityProfileModel.facilityName,
                                        ...
                                        SizedBox(
                                          width: 200.w,
                                          child: Text(
                                            widget.facilityProfileModel.facilityType ?? 'null',
                                            overflow: TextOverflow.ellipsis,
                                            maxLines: 1,
                                            softWrap: false,
                                            style: TextStyle(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                SizedBox(
                                                  width: 140.w,
                                                  child: Text(
                                                    widget.facilityProfileModel.location,
                                                    overflow: TextOverflow.ellipsis,
                                                    maxLines: 1,
                                                    softWrap: false,
                                                    style: TextStyle(
                            ...
                            BlocBuilder<LoginBloc, LoginState>(
                              builder: (context, state) {
                                if (state is LoginLoaded) {
                                  ...
                                  final facility = widget.facilityProfileModel;
                        ...
                        TabBar(
                          ...
                          onTap: (tabIdx) {
                            if (tabIdx == 3) return context.read<FacilityReviewsCubit>()..loadFacilityReviews();
                            // if (tabIdx == 2) return context.read<ListDepartmentsCubit>();
                          },
                ...
                children: [
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 15.w),
                              Text(
                                widget.facilityProfileModel.phoneNumber,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsets.only(left: 5.w),
                          child: Text(
                            widget.facilityProfileModel.overview,
                            maxLines: 5,
                            overflow: TextOverflow.ellipsis,
                            style: TextStyle(
                              color: textBlack,
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Opening Hours', style: sectionTitle),
                        SizedBox(height: 8.h),
                          ...
                          builder: (context, state) {
                            ...
                            if (state is ListFacilityOpenHoursSuccess) {
                              return ListView.builder(
                                shrinkWrap: true,
                                itemCount: state.openHours.length,
                                physics: NeverScrollableScrollPhysics(),
                                itemBuilder: (context, index) {
                                  final openHours = state.openHours[index];
                                  final day = state.openHours[index].day;
                                  final weekday = day == 1
                                      ? "Monday"
                                      : day == 2
                                          ? "Tuesday"
                                  ...
                                  return Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Spacer(),
                                        Text(
                                          'Opens - ${openHours.timeSlotFrom.replaceRange(5, 8, '')} | Closes - ${openHours.timeSlotFrom.replaceRange(5, 8, '')}',
                                          style: TextStyle(
                                            color: accentColorDark,
                                            fontWeight: FontWeight.w600,
                                            fontSize: 14.sp,
                            ...
                            if (state is ListFacilityOpenHoursFailure) {
                              return Container(
                                height: 20.h,
                                width: 20.h,
                                color: Colors.red,
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                context.read<PostFacilityReviewCubit>()..loadInitial();
                                showDialog(
                                  context: context,
                                  builder: (context) => WriteFacilityReviewDialog(),
                                );
                              },
