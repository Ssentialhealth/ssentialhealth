            ...
            children: [
              ...
              Theme(
                ...
                child: CheckboxListTile(
                  ...
                  onChanged: (val) async {
                    SharedPreferences prefs = await SharedPreferences.getInstance();
                    await prefs.setBool('sortFacilitiesByNearest', val);
              ...
              Theme(
                ...
                child: CheckboxListTile(
                  ...
                  onChanged: (val) async {
                    SharedPreferences prefs = await SharedPreferences.getInstance();
                    await prefs.setBool('sortFacilitiesByHighestRated', val);
                    setState(() {
                      highestRatedVal = val;
                    });
                  },
                ...
                child: ConstrainedBox(
                  ...
                  child: SfSlider(
                    ...
                    onChanged: (dynamic val) async {
                      SharedPreferences prefs = await SharedPreferences.getInstance();
                      final filterByDistance = prefs.getDouble('filterFacilitiesByDistance');
                      filterByDistance ?? prefs.remove('filterFacilitiesByDistance');
                      setState(() {
                        distanceVal = val;
                      });
                      await prefs.setDouble('filterFacilitiesByDistance', val);
                    },
                  ),
                ),
              ),
                ...
                child: ConstrainedBox(
                  ...
                  child: SfSlider(
                    ...
                    onChanged: (dynamic val) async {
                      ...
                      final filterByPrice = prefs.getDouble('filterFacilitiesByPrice');
                      filterByPrice ?? prefs.remove('filterFacilitiesByPrice');

                      setState(() {
                        priceVal = val;
                      });
                      await prefs.setDouble('filterFacilitiesByPrice', val);
                    },
                  ),
                ),
              ),
                  ...
                  onPressed: () async {
                    ...
                    context.read<ListFacilitiesCubit>()
                      ..filterFacilities(
                        ...
                        //done
                        filterByPrice: priceVal.toString(),
