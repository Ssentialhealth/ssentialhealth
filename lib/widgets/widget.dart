...
InputDecoration textFieldInputDecoration(String hintText) {
  return InputDecoration(
    ...
    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(5.0)), borderSide: BorderSide(color: Colors.black)),
  );
}
...
InputDecoration searchFieldInputDecoration(String hintText) {
  return InputDecoration(
    ...
    enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(5.0)), borderSide: BorderSide(color: Color(0xFF00FFFF))),
  );
}
...
Divider divider() {
  return Divider(height: 1, color: Color(0xFFC6C6C6));
}
